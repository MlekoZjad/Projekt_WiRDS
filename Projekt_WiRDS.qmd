...
Wykres przedstawia średnią ilość przepracowanych godzin w poszczególnych latach od 1995 roku.
...
Ta tablica reaktywna przedstawia różne wskaźniki związane z krajami Europy w roku 2000.
...
reactable(
  data = filtered_data_tab %>% select(country, child_mort, pop, gdpPercap, lex_female, lex_male, lex_syt), 
  ...
  columns = list(
    ...
    lex_syt = colDef(name = "Średnia długość życia")
  )
)
